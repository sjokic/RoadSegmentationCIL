"""
LinkNet model with dilation block.
...
class Dblock(pl.LightningModule):
...
class DinkNet(pl.LightningModule):
    def __init__(self, n_channels, n_filters, n_classes, loss_fn, metric, lr):
        super().__init__()
        ...
        filters = [self.n_filters, self.n_filters*2, self.n_filters * 4]
